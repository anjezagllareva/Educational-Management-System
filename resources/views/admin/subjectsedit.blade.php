...
<body>
  ...
  @csrf
        ...
        <input type="text" name="lecturer" id="lecturer" value="{{$sub->lecturer}}" class="form-control"></br>
        @error('name')
        ...
        <input type="text" name="subject" id="subject" value="{{$sub->subject}}" class="form-control"></br>
        <label>Email</label></br>
        <input type="email" name="email" id="email" value="{{$sub->email}}" class="form-control"></br>
