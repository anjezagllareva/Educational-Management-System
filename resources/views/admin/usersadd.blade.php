...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ url('/admin/admin')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Users</a>
  ...
  <div class="card-body">
      ...
      <form action="{{url('save-user/')}}" method="post">
        ...
        <input type="password" name="cpassword" id="cpassword" class="form-control"></br>
        <label>Role</label></br>
        <input type="number" name="role" id="role" class="form-control"></br>
