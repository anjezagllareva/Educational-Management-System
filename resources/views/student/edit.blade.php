        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ url('/student/admin')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <a href="{{ url('/student/widget') }}" class="nav-item nav-link"><i class="fas fa-calendar-alt me-2"></i>Widgets</a>
                    <a href="{{ url('/student/form') }}" class="nav-item nav-link"><i class="fas fa-list-ol me-2"></i>Forms</a>
                    <a href="{{ url('/student/table') }}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Tables</a>
                    <a href="{{ url('/student/chart') }}" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Charts</a>
                    <div class="nav-item dropdown">
