...
<body>
  ...
  <div class="card-header">Grading System</div>
  <div class="card-body"> 
  <form action="{{url('update-exams/')}}" method="post">
  @csrf
        <input type="hidden" name="id" value="{{$exams->id}}"/></br>
        <label>Name</label></br>
        <input type="text" name="name" id="name" value="{{$exams->name}}" class="form-control" readonly></br>
        @error('name')
        ...
        <input type="email" name="email" id="email" value="{{$exams->email}}" class="form-control" readonly></br>
        <label>Grade</label></br>
        <input type="text" name="grade" id="grade" value="{{$exams->grade}}" class="form-control"></br>
